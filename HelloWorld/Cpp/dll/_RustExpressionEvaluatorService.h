...
class ATL_NO_VTABLE CRustExpressionEvaluatorService :
	// Inherit from CRustExpressionEvaluatorServiceContract to provide the list of interfaces that
	// this class implements (interface list comes from RustExpressionEvaluator.vsdconfigxml)
	public CRustExpressionEvaluatorServiceContract,
	...
	// DllGetClassObject
	public CComCoClass<CRustExpressionEvaluatorService, &CRustExpressionEvaluatorServiceContract::ClassId>
{
protected:
	CRustExpressionEvaluatorService()
	{
	}
	~CRustExpressionEvaluatorService()
	{
...
public:
	DECLARE_NO_REGISTRY();
	DECLARE_NOT_AGGREGATABLE(CRustExpressionEvaluatorService);
...
OBJECT_ENTRY_AUTO(CRustExpressionEvaluatorService::ClassId, CRustExpressionEvaluatorService)